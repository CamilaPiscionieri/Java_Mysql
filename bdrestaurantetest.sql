...
-- Records of empleado
-- ----------------------------
INSERT INTO `empleado` VALUES ('1', '', '', '', '', 'COCINERO');
...
-- Records of pedido
-- ----------------------------
INSERT INTO `pedido` VALUES ('1', '11:48:10', '2018/11/02', 'ENTREGADO', '1', '1');
...
CREATE TABLE `registro_empleado` (
  ...
  `Fecha_registro_empleado` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
